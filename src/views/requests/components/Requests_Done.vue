...
export default {
  ...
  methods :{
    Get_Items(){
      Stores_Requests().Requests_Done().then(res=>{
  ...
  <q-card flat class="animation-fade-in">
    <q-card-section class="q-pt-sm">
      <div class="text-center">
        <strong class="text-teal-9 font-16">درخواست های پایان یافته </strong>
      </div>
      ...
      <template v-else>
        <template v-if="items.length < 1">
          <div class="text-center">
            ...
            <div>
              <strong class="text-red">شما درحال حاضر هیج درخواست پایان یافته ای ندارید !</strong>
            </div>
